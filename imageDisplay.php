...
// back to Shifting Pixel (either this page or shiftingpixel.com), but donÕt worry about
// including a big link on each page if you donÕt want toÐone will do just nicely. Feel
...
define('CACHE_DIR_NAME',		'/assets/uploads/');
